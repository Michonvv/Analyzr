...
import { CheckCircle, XCircle, AlertCircle, Code2, Cpu, Gauge } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <button className="flex items-center justify-center space-x-2 bg-indigo-100 text-indigo-700 p-2 rounded-md hover:bg-indigo-200 transition-colors">
